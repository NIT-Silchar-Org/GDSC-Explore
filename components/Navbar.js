    ...
    <>
      <div className="sticky top-[0px] z-[9999]  container-fluid ">
        <div className="flex justify-between items-center bg-[rgba(205,235,255,0.3)] bg-white h-[4.2rem] shadow-[0px_4px_17px_rgba(0,0,0,0.1)] px-[5%] md:px-[8%]">
          ...
          <div className="flex">
            <div
              className="hidden md:flex w-[400px] h-[100px] flex-row justify-between"
              id="lp-view"
            >
            ...
            <div className="md:hidden flex" id="mb-view">
              <button
                className="text-black p-2 mr-[0px]"
                onClick={() => {
                  handleToggle();
                }}
              >
      ...
      >
        <div
          id="sidebar"
          className="z-20 bg-white h-full w-[66%] px-[2.2rem] py-[1.5rem]"
        >
